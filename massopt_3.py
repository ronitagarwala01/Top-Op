...
boundary_1 = CompiledSubDomain('(x[0]-x_1)*(x[0]-x_1) + (x[1]-y_1)*(x[1]-y_1) <= (radius_1+0.015)*(radius_1+0.030) + tol', x_1=x_1, y_1=y_1, radius_1=radius_1, tol=DOLFIN_EPS)
boundary_2 = CompiledSubDomain('(x[0]-x_2)*(x[0]-x_2) + (x[1]-y_2)*(x[1]-y_2) <= (radius_2+0.015)*(radius_2+0.030) + tol', x_2=x_2, y_2=y_2, radius_2=radius_2, tol=DOLFIN_EPS)
boundary_3 = CompiledSubDomain('(x[0]-x_3)*(x[0]-x_3) + (x[1]-y_3)*(x[1]-y_3) <= (radius_3+0.015)*(radius_3+0.030) + tol', x_3=x_3, y_3=y_3, radius_3=radius_3, tol=DOLFIN_EPS)
