...
# C_max = Constant(1.2e-1)                        # Max Compliance
...
radii = np.array([0.20, 0.15, 0.18])            # Radii for circles
circle_coords = np.array([[0.67, 1.03, 1.4], [0.75, 0.25, 0.60]])
...
if __name__ == "__main__":
    ...
    parameters = {"acceptable_tol": 1.0e-3, "maximum_iterations": 200, "acceptable_tol": 1.0e-2, "max_cpu_time": 1000.0, "output_file": 'ipoptOut.txt', "file_print_level": 3}
    ...
    with open('ipoptOut.txt', 'r') as f:
        ...
        if last_line == "EXIT: Optimal Solution Found." or last_line == "EXIT: Solved To Acceptable Level.":
            converged = True
